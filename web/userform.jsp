<section class="d-flex container justify-content-center align-items-center">
    ...
    <div class="form-outline mb-2 row">
        <div class="">
            ...
            <input type="text" id="UID" class="form-control" name="userID" maxlength="5" required/>
        </div>
        <div class="">
            <label class="form-label" for="UFN">First Name</label>
            <input type="text" id="UFN" class="form-control" placeholder="Characters only." name="userFN" required/>
        </div>
        <div class="">
        ...
        <div class="">
            ...
            <input type="text" id="ULN" class="form-control" name="userLN" placeholder="Characters only."" required/>
        </div>
        <div class="">
            <label class="form-label" for="userR">User Role</label>
            <input type="text" id="userR" class="form-control" placeholder="" name="userRole" required/>
        </div>
    </div>  
